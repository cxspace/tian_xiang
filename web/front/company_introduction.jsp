            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <li>
                    <a href="${pageContext.request.contextPath}/front/order_list.jsp">购物车</a>
                  </li>
                  <li>
                    <a href="${pageContext.request.contextPath}/front/product.jsp">产品介绍</a>
                  </li>
                  <li>
                    <a href="${pageContext.request.contextPath}/front/company_introduction.jsp" class="active">公司介绍</a>
                  </li>
                  <li>
