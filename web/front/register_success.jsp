        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="col-md-6 text-center">
                    <img src="${pageContext.request.contextPath}/front/images/gou.png">
                </div>
                <div class="col-md-6 text-center">
                    <br>
                    <br>
                    ...
                    <br>
                    <div class="col-md-12 text-center">
                        <h1>注册成功,<span id="settime">2</span>秒回到登录页面...</h1>

                        <%response.setHeader("refresh","2;url="+request.getContextPath()+"/front/login.jsp");%>
