    ...
    <div class="row">
        ...
        <div class="span9">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                <%
                    List<Order> currentOrder = (List<Order>) session.getAttribute("nearly30Order");
                ...
                <tr>
                    ...
                    <td>
                        <form class="form-horizontal" role="form" method="post" action="${pageContext.request.contextPath}/ChangeOrderStatus?OrderId=<%=order.getOrderId()%>&day=30">
                            <div class="col-md-12 text-center">
                                <div class="col-md-2 text-left">

                                    <%
                                        if ((order.getStatus()).equals("未确认付款"))
                                        {
                                    %>
                                    <button type="submit" class="btn btn-info btn-ls">确认结清</button>
                                    <%
                                        }
                                    %>
